...
DATA_FOLDER = "test_data_ADNI_1805_call\\"
...
def main():
    ...
    summary3 = SummaryPlot_updated("free_MCI", BASE_PATH, [stats_free_MCI], d_folder=DATA_FOLDER)
    ...
    comp3 = Comparison_updated("FastSurfer", BASE_PATH, stats_fast_healthy, stats_fast_MCI, d_folder=DATA_FOLDER)
    comp4 = Comparison_updated("FreeSurfer", BASE_PATH, stats_free_healthy, stats_free_MCI, d_folder=DATA_FOLDER)
