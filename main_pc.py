...
def main_all():
    ...
    mmsefreeHealthy = SummaryPlot_updated("FreeHealthy", BASE_PATH, [stats_free_healthy], d_folder=DATA_FOLDER)
    mmsefreeHealthy.scatter_plot_aseg_mmse()
    mmsefastMCI = SummaryPlot_updated("FastPathologic", BASE_PATH, [stats_fast_MCI], d_folder=DATA_FOLDER)
    mmsefastMCI.scatter_plot_aseg_mmse()
    mmsefastHealthy = SummaryPlot_updated("FastHealthy", BASE_PATH, [stats_fast_healthy], d_folder=DATA_FOLDER)
    mmsefastHealthy.scatter_plot_aseg_mmse()
    mmsefreeMCI = SummaryPlot_updated("FastPathologic", BASE_PATH, [stats_free_MCI], d_folder=DATA_FOLDER)
    mmsefreeMCI.scatter_plot_aseg_mmse()
