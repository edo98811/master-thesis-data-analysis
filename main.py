...
def main():
    ...
    stats_fast_healthy = ft.Stats(table, "healthy_FAST", BASE_PATH, "'main condition'== 'Cognitively normal'")
    stats_fast_MC = ft.Stats(table, "MC_FAST", BASE_PATH, "'main condition'!= 'Cognitively normal'")

    stats_free_healthy = ft.Stats(table, "healthy_FREE", BASE_PATH, "'main condition'== 'Cognitively normal'")
    stats_free_MC = ft.Stats(table, "MC_FREE", BASE_PATH, "'main condition'!= 'Cognitively normal'", aseg=aseg_free,
